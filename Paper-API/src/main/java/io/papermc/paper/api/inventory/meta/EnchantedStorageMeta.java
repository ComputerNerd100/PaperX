...
public interface EnchantmentStorageMeta extends ItemMeta {
     ...
     */
    boolean hasStoredEnchant(@NonNull Enchantment ench);
     ...
     *     none
     */
    int getStoredEnchantLevel(@NonNull Enchantment ench);
     ...
     */
    boolean addStoredEnchant(@NonNull Enchantment ench, int level, boolean ignoreLevelRestriction);
     ...
     * @throws IllegalArgumentException if enchantment is null
     */
    boolean removeStoredEnchant(@NonNull Enchantment ench) throws IllegalArgumentException;
     ...
     */
    boolean hasConflictingStoredEnchant(@NonNull Enchantment ench);
