...
public interface InventoryView {
     ...
     *
     * If the slot ID is {@link InventoryType.SlotType#OUTSIDE} null will be returned, otherwise
     ...
     */
    InventoryType.@NonNull SlotType getSlotType(int slot);
     ...
     */
    boolean setProperty(@NonNull Property prop, int value);
