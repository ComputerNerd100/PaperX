...
public interface Permissible extends ServerOperator {
     ...
     */
    boolean isPermissionSet(@NonNull String name);
     ...
     * @return true if the permission is set, otherwise false
     */
    boolean isPermissionSet(@NonNull Permission perm);
     ...
     */
    @NonNull PermissionAttachment addAttachment(@NonNull Plugin plugin, @NonNull String name, boolean value);
     ...
     * @return The PermissionAttachment that was just created
     */
    @NonNull PermissionAttachment addAttachment(@NonNull Plugin plugin);
     ...
     * @return The PermissionAttachment that was just created
     */
    @Nullable PermissionAttachment addAttachment(@NonNull Plugin plugin, @NonNull String name, boolean value, int ticks);
     ...
     * @return The PermissionAttachment that was just created
     */
    @Nullable PermissionAttachment addAttachment(@NonNull Plugin plugin, int ticks);
     ...
     */
    @NonNull Set<PermissionAttachmentInfo> getEffectivePermissions();
     ...
     */
    default net.kyori.adventure.util.@NonNull TriState permissionValue(final @NonNull Permission permission) {
     ...
     * @return a tri-state of if the permission is set and, if it is set, it's value
     */
    default net.kyori.adventure.util.@NonNull TriState permissionValue(final @NonNull String permission) {
        if (this.isPermissionSet(permission)) {
            return net.kyori.adventure.util.TriState.byBoolean(this.hasPermission(permission));
        } else {
            return net.kyori.adventure.util.TriState.NOT_SET;
