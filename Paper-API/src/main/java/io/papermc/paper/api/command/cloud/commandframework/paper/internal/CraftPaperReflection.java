...
public final class CraftPaperReflection {
    ...
    static {
        final Class<?> serverClass = Paper.getServer().getClass();
        ...
        if (!nmsVersion.contains("_")) {
            ...
            try {
                ...
                fallbackVersion = Integer.parseInt(getMinecraftVersion.invoke(Paper.getServer()).toString().split("\\.")[1]);
    ...
    public static @NonNull Class<?> needNMSClassOrElse(
        ...
        return firstNonNullOrThrow(
                ...
                Arrays.stream(classNames)
                        .map(CraftPaperReflection::findClass)
                        .toArray(Class[]::new)
        );
    }
    ...
    public static @NonNull Class<?> needIPCClass(final @NonNull String className) throws RuntimeException {
    ...
    public static @Nullable Class<?> findIPCClass(final @NonNull String className) throws RuntimeException {
