...
public interface CraftingInventory extends Inventory {
     ...
     */
    @Nullable ItemStack @NonNull [] getMatrix(); // Paper - make array elements nullable instead array
     ...
     */
    void setMatrix(@Nullable ItemStack @NonNull [] contents); // Paper - make array elements nullable instead array
