...
public interface MapCanvas {
     ...
     */
    @NonNull MapCursorCollection getCursors();
     ...
     */
    void setCursors(@NonNull MapCursorCollection cursors);
     ...
     */
    void drawText(int x, int y, @NonNull MapFont font, @NonNull String text);
}
