...
public interface Inventory extends Iterable<ItemStack> {
     ...
     */
    @NonNull HashMap<Integer, ItemStack> addItem(@NonNull ItemStack... items) throws IllegalArgumentException;
     ...
     */
    @NonNull HashMap<Integer, ItemStack> removeItem(@NonNull ItemStack... items) throws IllegalArgumentException;
     ...
     */
    @NonNull
    HashMap<Integer, ItemStack> removeItemAnySlot(@NonNull ItemStack... items) throws IllegalArgumentException;
     ...
     */
    @Nullable ItemStack @NonNull [] getContents(); // Paper - make array elements nullable instead array
     ...
     *     inventory.
     */
    void setContents(@Nullable ItemStack @NonNull [] items) throws IllegalArgumentException; // Paper - make array elements nullable instead array
     ...
     */
    @Nullable ItemStack @NonNull [] getStorageContents(); // Paper - make array elements nullable instead array
     ...
     * inventory.
     */
    void setStorageContents(@Nullable ItemStack @NonNull [] items) throws IllegalArgumentException; // Paper - make array elements nullable instead array
     ...
     */
    boolean contains(@NonNull Material material) throws IllegalArgumentException;
     ...
     * @throws IllegalArgumentException if material is null
     */
    boolean contains(@NonNull Material material, int amount) throws IllegalArgumentException;
     ...
     */
    @NonNull
    HashMap<Integer, ? extends ItemStack> all(@NonNull Material material) throws IllegalArgumentException;
     ...
     */
    @NonNull
    HashMap<Integer, ? extends ItemStack> all(@Nullable ItemStack item);
     ...
     * @throws IllegalArgumentException if material is null
     */
    int first(@NonNull Material material) throws IllegalArgumentException;
     ...
     */
    int first(@NonNull ItemStack item);
     ...
     * @throws IllegalArgumentException if material is null
     */
    void remove(@NonNull Material material) throws IllegalArgumentException;
     ...
     * @param item The ItemStack to match against
     */
    void remove(@NonNull ItemStack item);
     ...
     */
    @Nullable
    InventoryHolder getHolder(boolean useSnapshot);
