...
public final class LocationArgument<C> extends CommandArgument<C, Location> {
    ...
    static class LocationParseException extends ParserException {
        ...
        public enum FailureReason {
            ...
            WRONG_FORMAT(PaperCaptionKeys.ARGUMENT_PARSE_FAILURE_LOCATION_INVALID_FORMAT),
            MIXED_LOCAL_ABSOLUTE(PaperCaptionKeys.ARGUMENT_PARSE_FAILURE_LOCATION_MIXED_LOCAL_ABSOLUTE);
