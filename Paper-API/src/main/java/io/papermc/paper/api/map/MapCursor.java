...
public final class MapCursor {
     ...
     * @param visible Whether the cursor is visible by default.
     */
    public MapCursor(byte x, byte y, byte direction, @NonNull Type type, boolean visible) {
        this(x, y, direction, type, visible, (String) null);
    }
     ...
     * @deprecated Magic value. Use {@link #MapCursor(byte, byte, byte, byte, boolean, Component)}
     */
    @Deprecated
     ...
     * @param caption cursor caption
     */
    public MapCursor(byte x, byte y, byte direction, @NonNull Type type, boolean visible, net.kyori.adventure.text.@Nullable Component caption) {
        this.x = x; this.y = y; this.visible = visible; this.caption = caption;
        setDirection(direction);
        setType(type);
    }
     ...
     * @param caption cursor caption
     */
    public MapCursor(byte x, byte y, byte direction, @NonNull Type type, boolean visible, @Nullable String caption) {
        this.x = x;
        this.y = y;
        setDirection(direction);
        setType(type);
