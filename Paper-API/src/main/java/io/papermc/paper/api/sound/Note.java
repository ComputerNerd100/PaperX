...
public class Note {
     ...
     */
    public Note(int octave, @NonNull Tone tone, boolean sharped) {
     ...
     */
    @NonNull
    public static Note flat(int octave, @NonNull Tone tone) {
     ...
     */
    @NonNull
    public static Note sharp(int octave, @NonNull Tone tone) {
     ...
     */
    @NonNull
    public static Note natural(int octave, @NonNull Tone tone) {
