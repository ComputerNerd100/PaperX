...
public enum EntityType implements Keyed, Translatable { // Paper - translatable
    ...
    public @NonNull String translationKey() {
        ...
        return Paper.getUnsafe().getTranslationKey(this);
    }
    ...
    public boolean hasDefaultAttributes() {
        return Paper.getUnsafe().hasDefaultEntityAttributes(this.key);
    }
     ...
     */
    public @NonNull Attributable getDefaultAttributes() {
        return Paper.getUnsafe().getDefaultEntityAttributes(this.key);
    }
