...
import io.papermc.paper.api.entity.ai.VanillaGoal;
...
public interface Dolphin extends WaterMob {
     ...
     * <p>
     * This value is calculated if the player has fed the dolphin a fish, and it tries to start the {@link VanillaGoal#DOLPHIN_SWIM_TO_TREASURE} goal.
     *
     ...
     */
    void setTreasureLocation(@NonNull Location location);
}
