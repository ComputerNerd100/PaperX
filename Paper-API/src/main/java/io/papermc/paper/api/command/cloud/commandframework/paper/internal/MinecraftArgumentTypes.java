...
public final class MinecraftArgumentTypes {
    ...
    static {
        if (CraftPaperReflection.classExists("org.bukkit.entity.Warden")) {
    ...
    private static final class ArgumentTypeGetterImpl implements MinecraftArgumentTypes.ArgumentTypeGetter {
        ...
        private ArgumentTypeGetterImpl() {
            ...
            try {
                final Field declaredField = CraftPaperReflection.needMCClass("commands.synchronization.ArgumentTypeInfos")
                        .getDeclaredFields()[0];
    ...
    private static final class LegacyArgumentTypeGetter implements ArgumentTypeGetter {
        ...
        static {
            try {
                ...
                if (CraftPaperReflection.findMCClass("resources.ResourceLocation") != null) {
                    minecraftKey = CraftPaperReflection.needMCClass("resources.ResourceLocation");
                    argumentRegistry = CraftPaperReflection.needMCClass("commands.synchronization.ArgumentTypes");
                } else {
                    minecraftKey = CraftPaperReflection.needNMSClassOrElse(
                            "MinecraftKey",
                            "net.minecraft.resources.MinecraftKey"
                    );
                    argumentRegistry = CraftPaperReflection.needNMSClassOrElse(
                            "ArgumentRegistry",
