...
public enum DisplaySlot {
    ...
    public static final Index<String, DisplaySlot> NAMES = Index.create(DisplaySlot.class, DisplaySlot::getId);

    private final String id;

    DisplaySlot(@NonNull String id) {
        this.id = id;
    }

    DisplaySlot(@NonNull NamedTextColor color) {
